...
import { AccountSheetService } from '../../features/accounts/services/account-sheet.service';
import { DataTableComponent, TableColumn } from '../../shared/components/data-table/data-table.component';
import { Account } from '../../features/accounts/services/accounts.service';
      ...
      <div class="bg-white rounded-xl border-none drop-shadow-sm">
        @if (accountsService.isLoading()) {
          ...
          <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-y-2 p-6 pb-2">
            <h1 class="text-xl font-semibold line-clamp-1">Accounts</h1>
...
export class AccountsComponent implements OnInit {
  ...
  ngOnInit() { this.accountsService.loadAll(); }
  onBulkDelete(ids: string[]) { this.accountsService.bulkDelete(ids); }
}
